...
class Field(Dump):
    ...
    def __init__(self, name = None, index= None, kind = None, component = None, plane= None, plane_offset= None, project = None, opacity = None, colormap = None, \
                 clip_min = None, clip_max = None, show_colorbar = None, z_order = None, file_kind = None, plot_data = None):
        ...
        """   
        Dump.__init__(self, name =name, index = index, plane=plane, colormap = colormap, z_order = z_order, file_kind=file_kind, plot_data = plot_data)
